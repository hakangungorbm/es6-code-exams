//Aşağıda ES6 öncesi yapılanları ES6 ya göre yapacağız.
//Asagida UI seklinde 1 tane constructor imiz var. Bu UI objesi icersinde herhangi bir ozellik (degisken vs) 
//bulunmuyor. Sadece prototype ina tanimladigimiz metodlari bulunuyor. 
//Bu methodlari static metodlar olarak yazarsak obje olusturmamiza gerek kalmadan UI uzerinden kullanabiliriz.
//
...
class UI {
    ...
    static clearFormInputs (element1, element2, element3) {
        element1.value = "";
        element2.value = "";
        element3.value = "";
    }
    ...
    static displayMessages (message,type) {   // Hangi mesaji yazdiracagimiz(message) ve tipi(type)
